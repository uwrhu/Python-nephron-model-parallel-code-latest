...
N = int(N)
method = 'Newton'
cell=compute(N,filename,method,sup_or_jux,diabete=diabete,humOrrat=humOrrat,sup_or_multi = sup_or_multi,inhibition=inhib,unx = unx)
if sup_or_jux != '':
...
for j in range(1,N):
	...
	file_na_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_Na_apical_ecd.txt','a')
	file_na_apical.write(str(jsol[0,0,1])+'\n')
	file_k_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_K_apical_ecd.txt','a')
	file_k_apical.write(str(jsol[1,0,1])+'\n')
	file_nh4_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_NH4_apical_ecd.txt','a')
	file_nh4_apical.write(str(jsol[10,0,1])+'\n')
	file_h_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_H_apical_ecd.txt','a')
	file_h_apical.write(str(jsol[11,0,1])+'\n')
	file_cl_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_Cl_apical_ecd.txt','a')
	file_cl_apical.write(str(jsol[2,0,1])+'\n')
	file_hco3_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HCO3_apical_ecd.txt','a')
	file_hco3_apical.write(str(jsol[3,0,1])+'\n')
	file_hpo4_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HPO4_apical_ecd.txt','a')
	file_hpo4_apical.write(str(jsol[6,0,1])+'\n')
	file_h2po4_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_H2PO4_apical_ecd.txt','a')
	file_h2po4_apical.write(str(jsol[7,0,1])+'\n')
	file_hco2_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HCO2_apical_ecd.txt','a')
	file_hco2_apical.write(str(jsol[12,0,1])+'\n')
	file_nh3_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_NH3_apical_ecd.txt','a')
	file_nh3_apical.write(str(jsol[9,0,1])+'\n')
	file_glu_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_glu_apical_ecd.txt','a')
	file_glu_apical.write(str(jsol[14,0,1])+'\n')

	file_na_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_Na_para_ecd.txt','a')
	file_na_para.write(str(jsol[0,0,4])+'\n')
	file_k_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_K_para_ecd.txt','a')
	file_k_para.write(str(jsol[1,0,4])+'\n')
	file_nh4_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_NH4_para_ecd.txt','a')
	file_nh4_para.write(str(jsol[10,0,4])+'\n')
	file_h_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_H_para_ecd.txt','a')
	file_h_para.write(str(jsol[11,0,4])+'\n')
	file_cl_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_Cl_para_ecd.txt','a')
	file_cl_para.write(str(jsol[2,0,4])+'\n')
	file_hco3_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HCO3_para_ecd.txt','a')
	file_hco3_para.write(str(jsol[3,0,4])+'\n')
	file_hpo4_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HPO4_para_ecd.txt','a')
	file_hpo4_para.write(str(jsol[6,0,4])+'\n')
	file_h2po4_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_H2PO4_para_ecd.txt','a')
	file_h2po4_para.write(str(jsol[7,0,4])+'\n')
	file_hco2_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HCO2_para_ecd.txt','a')
	file_hco2_para.write(str(jsol[12,0,4])+'\n')
	file_nh3_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_NH3_para_ecd.txt','a')
	file_nh3_para.write(str(jsol[9,0,4])+'\n')
	file_glu_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_glu_para_ecd.txt','a')
	...
	for i in range(len(cell[j].trans)):
		...
		if transporter_type == 'SGLT1':
			...
			for k in range(len(solute_id)):
				file = open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_'+transporter_type+'_'+solute[solute_id[k]]+'.txt','a')
			...
			for k in range(len([solute_id])):
				file = open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_'+transporter_type+'_'+solute[solute_id]+str(memb_id[0])+str(memb_id[1])+'.txt','a')
			...
			for k in range(len(solute_id)):
				file = open('./'+file_to_save+'/'+cell[j].sex+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_'+transporter_type+'_'+solute[solute_id[k]]+str(memb_id[0])+str(memb_id[1])+'.txt','a')
				file.write(str(fluxs[k])+'\n')
...
# 		file_cell_lis = open(cell[j].sex+'_'+cell[j].segment+'_'+'NaHexchanger_Cell_LIS.txt','a')
